			 ...
			 <div class="col-sm-12">
				<div class="panel panel-bd">
					...
					<div class="panel-body">
						<form method="POST" id="frm" autocomplete="off" action="<?php echo base_url("account/tnc/add"); ?>">
							<div class="row">
								<div class="col-sm-4">
										...
										<select class="form-control" id="tnc_type" name="tnc_type" onchange="change_status('tnc_type_div')">
											...
											<?php
												if(sizeof($tnc_type))
												{
													...
													{
														?>
															<option value="<?php echo $tnc_type[$i]['id']; ?>"><?php echo $tnc_type[$i]['tnc_type_name']; ?></option>
														<?php
													}
												}
											?>
								...
								<div class="col-sm-4">
									<div class="form-group tnc_name_div">
										...
										<input type="text" class="form-control" id="tnc_name" name="tnc_name"  placeholder="TNC Name" onkeyup="change_status('tnc_name_div')"/>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group description_div">
										...
										<textarea rows="3" cols="50" type="text" class="form-control" id="summernote2" name="description" placeholder="Description" onkeyup="change_status('description_div')"></textarea>
									</div>
								</div>
							</div>							
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<button type="submit" class="btn btn-base pull-left">Add TNC</button>
