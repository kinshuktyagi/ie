			 ...
			 <div class="col-sm-12">
				<div class="panel panel-bd">
					...
					<div class="panel-body">
						<form method="POST" id="frm" autocomplete="off" action="<?php echo base_url("account/tax/update_tax"); ?>">
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group tax_name_div">
										...
										<input type="text" class="form-control" id="tax_name" name="tax_name"  placeholder="Tax Name" onkeyup="change_status('tax_name_div')" value="<?php echo $info['tax_name']?>"/>
									</div>
								</div>
							</div>
							<div class="row">
										...
										<select class="form-control" id="tax_type" name="tax_type" onchange="change_status('tax_type_div')">
											...
											<?php
												if(sizeof($tax_type))
												{
													...
													{
														?>
															<option value="<?php echo $tax_type[$i]['id'];?>" <?php echo $tax_type[$i]['id'] == $info['tax_type_id']? 'selected' :''?>><?php echo $tax_type[$i]['tax_type']; ?></option>
														<?php
													}
												}												
											?>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group tax_value_div">
										...
										<input type="text" class="form-control" id="tax_value" name="tax_value" placeholder="Tax Value" onkeyup="change_status('tax_value_div')" value="<?php echo $info['tax_value']?>"/>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group description_div">
										...
										<textarea rows="4" cols="50" type="text" class="form-control" id="description"  name="description" placeholder="Description" onkeyup="change_status('description_div')"><?php echo $info['description']?></textarea>
									</div>
								</div>
							</div>
							<input type="hidden" name="tax_id" value="<?php echo $info['tax_id']; ?>"/>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<button type="submit" class="btn btn-base pull-left">Update Tax</button>
