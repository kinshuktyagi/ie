			...
			<div class="col-sm-12">
				<div class="panel panel-bd">
					...
					<div class="panel-body">
						<form method="POST" id="frm" autocomplete="off" action="<?php echo base_url("account/product/add"); ?>">
							<div class="row">
										...
										<select class="form-control basic-single" id="pro_category" name="pro_category" onchange="change_status('pro_category_div')">
											...
											<?php
												if(sizeof($product_cat))
												{
													...
													{
														?>
															<option value="<?php echo $product_cat[$i]['id']; ?>"<?php echo $product_cat[$i]['id']==$cat_id?'selected':''?>><?php echo $product_cat[$i]['raw_material_category_name']; ?></option>
														<?php
													}
												}
											?>
								...
								<div class="col-sm-4">
									<div class="form-group pro_sub_category_div">
										...
										<select class="form-control basic-single" id="pro_sub_category" name="pro_sub_category" onchange="change_status('pro_sub_category_div')">
											<option selected disabled value="">Select Product Category First</option>
											<?php
												if(sizeof($product_sub_cat))
												{
													...
													{
														?>
															<option value="<?php echo $product_sub_cat[$i]['id']; ?>" <?php echo $product_sub_cat[$i]['id']==$sub_cat_id?'selected':''?>><?php echo $product_sub_cat[$i]['sub_cat_name']; ?></option>
														<?php
													}
												}
											?>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group storage_type_div">
										...
										<select class="form-control basic-single" id="storage_type" name="storage_type" onchange="change_status('storage_type_div')">
											...
											<?php
												if(sizeof($storage_type))
												{
													...
													{
														?>
															<option value="<?php echo $storage_type[$i]['id']; ?>"><?php echo $storage_type[$i]['storage_type_name']; ?></option>
														<?php
													}
												}
											?>
								...
								<div class="col-sm-4">
									<div class="form-group product_name_div">
										...
										<input type="text" class="form-control" id="product_name" name="product_name" placeholder="Product Name" onkeyup="change_status('product_name_div')"/>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group hsn_code_div">
										...
										<input type="text" class="form-control" id="hsn_code" name="hsn_code" placeholder="HSN Code" onkeyup="change_status('hsn_code_div')"/>
									</div>
								</div>
							...
							<div class="row">								
								<div class="col-sm-4">
									<div class="form-group trash_hold_div">
										...
										<input type="text" class="form-control" id="trash_hold" name="trash_hold" placeholder="Minimum Quantity" onkeyup="change_status('trash_hold_div',integer('trash_hold'))"/>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group uom_div">
										...
										<select class="form-control basic-single" id="uom" name="uom" onchange="change_status('uom_div')">
								...
								<div class="col-sm-4">
									<div class="form-group dimension_div">
										...
										<input type="text" class="form-control" id="dimension" name="dimension" placeholder="Dimension" onkeyup="change_status('dimension_div')"/>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group stress_relieved_div">
										...
										<input type="text" class="form-control" id="stress_relieved" name="stress_relieved" placeholder="STRESS RELIEVED" onkeyup="change_status('stress_relieved_div')"/>
									</div>
								</div>
							</div>
							<hr>
								...
								<div class="col-sm-4" style="<?php if(!in_array(1,$sub_cat_data)){ echo'display:none;'; } ?>">
									<div class="form-group weight_div">
										...
										<input type="text" class="form-control" id="weight" name="weight" placeholder="Weight" onkeyup="change_status('weight_div')" />
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(2,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group length_div">
										...
										<input type="text" class="form-control" id="length" name="length" placeholder="Thikness" onkeyup="change_status('length_div')"/>
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(3,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group width_div">
										...
										<input type="text" class="form-control" id="width" name="width" placeholder="Width" onkeyup="change_status('width_div')" />
									</div>
								</div>
								...
								<div class="col-sm-4" style="<?php if(!in_array(4,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group thickness_div">
										...
										<input type="text" class="form-control" id="thickness" name="thickness" placeholder="Thickness" onkeyup="change_status('thickness_div')" />
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(5,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group height_div">
										...
										<input type="text" class="form-control" id="height" name="height" placeholder="Height" onkeyup="change_status('height_div')"/>
									</div>
								</div>
										...
										<select class="form-control basic-single" id="materials" name="materials" onchange="change_status('materials_div')">
											...
											<?php
												if(sizeof($materials_info))
												{
													...
													{
														?>
															<option value="<?php echo $materials_info[$i]['data_id']; ?>"><?php echo $materials_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
								...
								<div class="col-sm-4" style="<?php if(!in_array(7,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group radius_div">
										...
										<input type="text" class="form-control" id="radius" name="radius" placeholder="Radius" onkeyup="change_status('radius_div')" />
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(8,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group diameter_div">
										...
										<input type="text" class="form-control" id="diameter" name="diameter" placeholder="Diameter" onkeyup="change_status('diameter_div')"/>
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(9,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group volume_div">
										...
										<input type="text" class="form-control" id="volume" name="volume" placeholder="Volume" onkeyup="change_status('volume_div')" />
									</div>
								</div>
								...
								<div class="col-sm-4" style="<?php if(!in_array(10,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group shank_length_div">
										...
										<input type="text" class="form-control" id="shank_length" name="shank_length" placeholder="Shank Length" onkeyup="change_status('shank_length_div')" />
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(11,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group no_of_teeth_div">
										...
										<input type="text" class="form-control" id="no_of_teeth" name="no_of_teeth" placeholder="No Of Teeth" onkeyup="change_status('no_of_teeth_div')"/>
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(12,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group cutting_radius_div">
										...
										<input type="text" class="form-control" id="cutting_radius" name="cutting_radius" placeholder="Cutting Radius" onkeyup="change_status('cutting_radius_div')" />
									</div>
								</div>
										...
										<select class="form-control basic-single" id="cutting_tip" name="cutting_tip" onchange="change_status('cutting_tip_div')">
											...
											<?php
												if(sizeof($cutting_tip_info))
												{
													...
													{
														?>
															<option value="<?php echo $cutting_tip_info[$i]['data_id']; ?>"><?php echo $cutting_tip_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
								...
								<div class="col-sm-4" style="<?php if(!in_array(14,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group thread_diameter_div">
										...
										<input type="text" class="form-control" id="thread_diameter" name="thread_diameter" placeholder="Thresd Diameter" onkeyup="change_status('thread_diameter_div')"/>
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(15,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group thread_pitch_div">
										...
										<input type="text" class="form-control" id="thread_pitch" name="thread_pitch" placeholder="Thread Pitch" onkeyup="change_status('thread_pitch_div')" />
									</div>
								</div>
										...
										<select class="form-control basic-single" id="milling_tool_type" name="milling_tool_type" onchange="change_status('milling_tool_type_div')">
											...
											<?php
												if(sizeof($milling_tool_info))
												{
													...
													{
														?>
															<option value="<?php echo $milling_tool_info[$i]['data_id']; ?>"><?php echo $milling_tool_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
										...
										<select class="form-control basic-single" id="boring_tool_type" name="boring_tool_type" onchange="change_status('boring_tool_type_div')">
											...
											<?php
												if(sizeof($boring_tool_info))
												{
													...
													{
														?>
															<option value="<?php echo $boring_tool_info[$i]['data_id']; ?>"><?php echo $boring_tool_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
										...
										<select class="form-control basic-single" id="drilling_tool_type" name="drilling_tool_type" onchange="change_status('drilling_tool_type_div')">
											...
											<?php
												if(sizeof($drilling_tool_info))
												{
													...
													{
														?>
															<option value="<?php echo $drilling_tool_info[$i]['data_id']; ?>"><?php echo $drilling_tool_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
										...
										<select class="form-control basic-single" id="reaming_tool_type" name="reaming_tool_type" onchange="change_status('reaming_tool_type_div')">
											...
											<?php
												if(sizeof($reaming_tool_info))
												{
													...
													{
														?>
															<option value="<?php echo $reaming_tool_info[$i]['data_id']; ?>"><?php echo $reaming_tool_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
										...
										<select class="form-control basic-single" id="threading_tool_type" name="threading_tool_type" onchange="change_status('threading_tool_type_div')">
											...
											<?php
												if(sizeof($threading_tool_info))
												{
													...
													{
														?>
															<option value="<?php echo $threading_tool_info[$i]['data_id']; ?>"><?php echo $threading_tool_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
										...
										<select class="form-control basic-single" id="special_tool_type" name="special_tool_type" onchange="change_status('special_tool_type_div')">
											...
											<?php
												if(sizeof($special_tool_info))
												{
													...
													{
														?>
															<option value="<?php echo $special_tool_info[$i]['data_id']; ?>"><?php echo $special_tool_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
										...
										<select class="form-control basic-single" id="adapter_machine_side" name="adapter_machine_side" onchange="change_status('adapter_machine_side_div')">
											...
											<?php
												if(sizeof($adapter_machine_side_info))
												{
													...
													{
														?>
															<option value="<?php echo $adapter_machine_side_info[$i]['data_id']; ?>"><?php echo $adapter_machine_side_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
										...
										<select class="form-control basic-single" id="adapter_nose_type" name="adapter_nose_type" onchange="change_status('adapter_nose_type_div')">
											...
											<?php
												if(sizeof($adapter_nose_info))
												{
													...
													{
														?>
															<option value="<?php echo $adapter_nose_info[$i]['data_id']; ?>"><?php echo $adapter_nose_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
										...
										<select class="form-control basic-single" id="pull_stud_type" name="pull_stud_type" onchange="change_status('pull_stud_type_div')">
											...
											<?php
												if(sizeof(pull_stud_info))
												{
													...
													{
														?>
															<option value="<?php echo $pull_stud_info[$i]['data_id']; ?>"><?php echo $pull_stud_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
								...
								<div class="col-sm-4" style="<?php if(!in_array(25,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group accessory_name_div">
										...
										<input type="text" class="form-control" id="accessory_name" name="accessory_name" placeholder="Weight" onkeyup="change_status('accessory_name_div')" />
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(26,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group rabge_div">
										...
										<input type="text" class="form-control" id="range" name="range" placeholder="Range" onkeyup="change_status('rabge_div')"/>
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(27,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group least_count_div">
										...
										<input type="text" class="form-control" id="least_count" name="least_count" placeholder="Least Count" onkeyup="change_status('least_count_div')" />
									</div>
								</div>
								...
								<div class="col-sm-4" style="<?php if(!in_array(28,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group last_calibration_date_div">
										...
										<input type="text" class="form-control datetimepicker2" id="last_calibration_date" name="last_calibration_date" placeholder="Date" onkeyup="change_status('last_calibration_date_div')" />
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(29,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group next_calibration_date_div">
										...
										<input type="text" class="form-control datetimepicker2" id="next_calibration_date" name="next_calibration_date" placeholder="Date" onkeyup="change_status('next_calibration_date_div')"/>
									</div>
								</div>
										...
										<select class="form-control basic-single" id="insert_shape" name="insert_shape" onchange="change_status('insert_shape_div')">
											...
											<?php
												if(sizeof($insert_shape_info))
												{
													...
													{
														?>
															<option value="<?php echo $insert_shape_info[$i]['data_id']; ?>"><?php echo $insert_shape_info[$i]['data_name']; ?></option>
														<?php
													}
												}
											?>
								...
								<div class="col-sm-4" style="<?php if(!in_array(31,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group insert_material_div">
										...
										<input type="text" class="form-control" id="insert_material" name="insert_material" placeholder="Insert Material" onkeyup="change_status('insert_material_div')" />
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(32,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group insert_product_code_div">
										...
										<input type="text" class="form-control" id="insert_product_code" name="insert_product_code" placeholder="Insert Product Code" onkeyup="change_status('insert_product_code_div')"/>
									</div>
								</div>
								<div class="col-sm-4" style="<?php if(!in_array(33,$sub_cat_data)){ echo'display:none;';} ?>">
									<div class="form-group no_of_cutting_edge_div">
										...
										<input type="text" class="form-control" id="no_of_cutting_edge" name="no_of_cutting_edge" placeholder="NO Of Cutting Edge" onkeyup="change_status('no_of_cutting_edge_div')" />
									</div>
								</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<button type="submit" class="btn btn-base pull-left">Add Product</button>
...
<script>
	...
	// get the sub cat details on change of cat..
	...
	$("#pro_sub_category").change(function()
	{
		...
		if(sub_catID)
		{
			document.location="<?php echo base_url("account/product/add_product?sub_cat=")?>"+sub_catID;
		}
		else
		{
			document.location="<?php echo base_url("account/product/add_product") ?>";
		}
	});
	...
	$("#frm").submit(function(e)
	{
		...
		{
			$(".vendor_sele_div").addClass("has-danger");
			flag="False";
		}
		if(pro_type=="" || pro_type==null)
		{
			$(".pro_type_div").addClass("has-danger");
			flag="False";
		}
		...
		if(pro_sub_category=="" || pro_sub_category==null)
		{
			$(".pro_sub_category_div").addClass("has-danger");
			flag="False";
		}
		if(sku_code=="")
		{
			$(".sku_code_div").addClass("has-danger");
			flag="False";
		}
		if(price=="")
		{
