			 ...
			 <div class="col-sm-12">
				<div class="panel panel-bd">
					...
					<div class="panel-body">
						<form method="POST" id="frm" autocomplete="off" action="<?php echo base_url("account/user/add"); ?>">
							<!--<div class="row">
								<div class="col-sm-4">
										...
										<select class="form-control" id="designation" name="designation" onchange="change_status('designation_div')">
											...
											<?php
												if(sizeof($designation))
												{
													...
													{
														?>
															<option value="<?php echo $designation[$i]['id']; ?>"><?php echo $designation[$i]['designation_name']; ?></option>
														<?php
													}
												}
											?>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group first_name_div">
										...
										<input type="text" class="form-control" id="first_name" name="first_name"  placeholder="First Name" onkeyup="change_status('first_name_div')"/>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group password_div">
										...
										<input type="password" class="form-control" id="password" name="password" placeholder="Password" onkeyup="change_status('mobile_div')"/>
									</div>
								</div>
								<div class="col-sm-4">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" class="form-control datetimepicker2" id="join_date" name="join_date" placeholder="Join Date" readonly>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<button type="submit" class="btn btn-base pull-left">Add User</button>
