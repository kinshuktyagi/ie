		...
		<div class="content-header">
			...
			<div class="header-title">
				...
				<ol class="breadcrumb">
					...
					<!--<li><a href="<?php echo base_url("account/notification/index"); ?>">Department List</a></li>-->
			 ...
			 <div class="col-sm-12">
				<div class="panel panel-bd">
					...
					<div class="panel-body">
						<form method="POST" id="frm" autocomplete="off" action="<?php echo base_url("account/notification/add"); ?>">
										...
										<select class="form-control" id="user_type" name="user_type" onchange="change_status('user_type_div')">
											...
											<?php
												if(sizeof($user_type))
												{
													...
													{
														?>
															<option value="<?php echo $user_type[$i]['id']; ?>"><?php echo $user_type[$i]['user_type']; ?></option>
														<?php
													}
												}
											?>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group notification_name_div">
										...
										<input type="text" class="form-control" id="notification_name" name="notification_name"  placeholder="Notification Name" onkeyup="change_status('notification_name_div')"/>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group end_date_div">
										<label for="join_date" class="form-control-label" id="join_date_lbl">End Date</label>
										<input type="text" class="form-control datetimepicker2" id="end_date" name="end_date" placeholder="End Date" readonly>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-8">
									<div class="form-group description_div">
										...
										<textarea rows="4" cols="100" type="text" class="form-control" id="description" name="description" placeholder="Description" onkeyup="change_status('description_div')"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="row"> 
								<div class="form-group checkbox checkbox-success checkbox-inline col-sm-4">
									<input type="checkbox" id="inlineCheckbox2" name="email_send" value="True">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<button type="submit" class="btn btn-base pull-left">Add Notification</button>
