	...
	<div class="content">
		...
		<div class="content-header">
			...
			<div class="header-title">
				...
				<small>Inventory Request List.</small>
				<ol class="breadcrumb">
					<li><a href="<?php echo base_url("account"); ?>"><i class="pe-7s-home"></i>Home</a></li>
					<li><a href="#">Inventory Request Master</a></li>
					<li class="active">Inventory Request List</li>
				</ol>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-sm-12 text-right">
				<a href="<?php echo base_url("account/inventory_request/add_inventory_request"); ?>"><button type="button" class="btn btn-primary w-md m-rb-5">Add Inventory Request</button></a>
				<a href="<?php echo base_url("account/inventory_request/reset_filter"); ?>"><button type="button" class="btn btn-warning w-md m-rb-5">Reset Filter</button></a>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
				<div class="panel lobidisable panel-bd">
					<div class="panel-heading">
						<div class="panel-title">
							<h4>Inventory Request List</h4>
						</div>
					</div>
					<form method="POST" action="<?php echo base_url("account/inventory_request/index"); ?>">
													...
													<tr>
														...
														<td>
															<?php 
																...
																else if($user[$i]['request_status']=="Partial-Complete")
																{
		...
		<script>
			...
			$(".action").change(function()
			{
				...
				if(action=='Disable')
				{
					document.location="<?php echo base_url("account/inventory_request/disable?dept=") ?>"+id;
				}
				if(action=='Enable')
				{
					document.location="<?php echo base_url("account/inventory_request/enable?dept=") ?>"+id;
				}
				if(action=='Manage')
				{
					document.location="<?php echo base_url("account/inventory_request/manage?dept=") ?>"+id;
				}
				if(action=='view')
				{
					document.location="<?php echo base_url("account/inventory_request/view?id=") ?>"+id;
				}
				if(action=='approve')
				{
					document.location="<?php echo base_url("account/inventory_request/approve?id=") ?>"+id;
				}
			});
