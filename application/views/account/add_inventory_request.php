			 ...
			 <div class="col-sm-12">
				<div class="panel panel-bd">
					...
					<div class="panel-body">
						<form method="POST" id="frm" autocomplete="off" action="<?php echo base_url("account/inventory_request/add_inventory_request"); ?>">
							<div class="row">
								<div class="col-sm-3">
					...
					<?php 
						...
						{	$issu_product = $issue_stock['issu_product'];
							...
							<hr>
								<form method="POST" id="frm_final" autocomplete="off" action="<?php echo base_url("account/inventory_request/add"); ?>">						
									<div class="row">
										<div class="col-sm-3">
											<div class="form-group production_date_div">
												...
												<input type="text" class="form-control datetimepicker2" id="production_date" name="production_date" placeholder="Production Date" onchange="change_status('production_date_div')"/>
											</div>
										</div>
										<div class="col-sm-4">
