			 ...
			 <div class="col-sm-12">
				<div class="panel panel-bd">
					...
					<div class="panel-body">
						<form method="POST" id="frm" autocomplete="off" action="<?php echo base_url("account/inventory_issue/update_inventory_issue"); ?>">
							<?php							
								...
								<div class="row">
									<div class="col-sm-3">
										<div class="form-group production_date_div">
											...
											<input type="text" class="form-control datetimepicker2" id="production_date" name="production_date" placeholder="Production Date" onkeyup="change_status('production_date_div')" value="<?php echo $info['production_date']?>"/>
										</div>
									</div>
									<div class="col-sm-4">
