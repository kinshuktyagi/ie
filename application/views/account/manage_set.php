				...
				<div class="panel lobidisable panel-bd">
					<div class="panel-heading">
						<div class="panel-title">
							<h4>Manage Role Set</h4>
						</div>
					</div>
					<form method="POST" id="frm" action="<?php echo base_url("account/set/update_set"); ?>">
						 <div class="panel-body">
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group set_name_div">
										...
										<input type="text" class="form-control" id="set_name" name="set_name" value="<?php echo $info['set_name']; ?>" placeholder="Set Name" onkeyup="change_status('set_name_div')"/>
										
										<input type="hidden"  name="set_id" value="<?php echo $info['set_id']; ?>"/>
									</div>
								</div>
								...
								<div class="col-sm-4">
									<div class="form-group description_div">
										...
										<input type="text" class="form-control" id="description" name="description" value="<?php echo $info['description']; ?>"  placeholder="Set Description" onkeyup="change_status('description_div')"/>
									</div>
								</div>
							</div>
								<div class="">
																	...
																	for($j=0;$j<sizeof($permission);$j++)
																	{
																		...
																		?>
																			...
																			<div class="checkbox">
																				...
																				<input type="checkbox" class="permission" name="permission[]" <?php if(in_array($role_id,$ans)){ echo'checked'; } ?> id="option<?php echo $count; ?>" value="<?php echo $role_id; ?>" />
							...
							<div class="row">
								<div class="col-sm-2">
									<button type="submit" class="btn btn-primary w-md m-rb-5">Update Set</button>
								</div>
							</div>
						</div>
					</form>
