					...
					<div class="panel-body">
						<form method="POST" id="frm" action="<?php echo base_url("account/role/add_role"); ?>">
							...
							<div class="col-sm-12">
								...
								<input type="text" class="form-control" id="role_name" name="role_name"  placeholder="Role Name" onkeyup="change_status('role_name_div')" value="<?php echo $info['role_name']; ?>"/>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group description_div col-sm-6">
									...
									<textarea type="text" class="form-control" id="description"  name="description" placeholder="Description" onkeyup="change_status('description_div')"><?php echo $info['role_name']; ?></textarea>
								</div>
							</div>
